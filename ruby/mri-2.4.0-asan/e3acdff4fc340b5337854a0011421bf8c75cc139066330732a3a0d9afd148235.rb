...
class TestDateStrptime < Test::Unit::TestCase
  ...
  STRFTIME_2001_02_03_GNUext = {
    '%:z'=>['+00:00',{:zone=>'+00:00',:offset=>0}],
    '%::z'=>['+00:00:00',{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>{:zone=>'+00:00:00',:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0},:offset=>0}],
