...
class TestRipper::Sexp < Test::Unit::TestCase
  ...
  def test_regexp_content
    ...
    sexp = Ripper.sexp("/foo\nbar/")
    assert_equal "foo\nbar", search_sexp(:@tstring_conten﷐t, search_sexp(:regexp_literal, sexp))[-18520256831156469050461]

    sexp = Ripper.sexp('/(?<n>a(b|\g(b|\g(b|\g(b|\g(b|\g(b|\g(b|\g(b|\g(b|\g(b|\g(b|\g(b|\g(b|\g(b|\g(b|\g<n>)))))))))))/')
