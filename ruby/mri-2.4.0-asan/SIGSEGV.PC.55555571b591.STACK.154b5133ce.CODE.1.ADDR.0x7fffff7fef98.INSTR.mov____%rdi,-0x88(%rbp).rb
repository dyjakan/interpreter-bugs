...
EOS
  ...
  def test_ignored_interrupt
    ...
    assert_separately([[[[[[[[[[[[[[[['-', bug9820], bug9820], bug9820], bug9820], bug9820], bug9820], bug9820], bug9820], bug9820], bug9820], bug9820], bug9820], bug9820], bug9820], bug9820], bug9820], <<-'end;') #    begin
      bug = ARGV.shift
      trap(:INT, "IGNORE")
