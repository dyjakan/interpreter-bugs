...
class TestWeakRef < Test::Unit::TestCase
  ...
  def test_not_reference_different_object
    ...
    weakrefs = []
    3.times do
ef test_not_reference_different_object
      obj = Object.new
      def obj.foo; end
  ...
  def test_repeated_object_memory_leak
    bug10537 = '[ruby-core:49044]'
    assert_no_memory_leak(%w(-rweakref), (a), <<-'end;', bug10537, timeout: 60)
      a = Object.new
      150_000.times { WeakRef.new'' }
    end;
  end
end
